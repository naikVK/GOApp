...
module.exports = {
  ...
  pwa: {
    ...
    runtimeCaching: [
      {
        // Match any same-origin request that contains 'onlineClassroomServer'.
        urlPattern: /onlineClassroomServer/,
      ...
      },
      {
        ...
        urlPattern: /(.html)|(.png)|(.js)|(.css)|(.woff2)|(.ico)|(.jpg)|(superpointasset)/,
  ...
  devServer: {
    proxy: {
      '/localserver': {
        target: 'https://mepcs.mkcl.org/1LUEW7fJDMkpbkkdeyP9xlAjKmu/',
        // target: 'http://localhost:40031/',
        ws: true,
        changeOrigin: true,
        pathRewrite: {
          '^/localserver': ''
      ...
      '/cloudServer': {
        target: 'https://mepcs.mkcl.org/1LUEiFHwJdv61A3kxMfl9G2ZKMT/',
        ws: true,
        changeOrigin: true,
        pathRewrite: {
          '^/cloudServer': ''
      ...
      '/GatewayServer': {
        // For proxy to point at superschoolstg gateway server
        target: 'https://mepcs.mkcl.org/1XI3l1W9pW7a2gUGtKppUTXUKXd/',
        // For proxy to point at ssstg gateway server
        // target: 'https://ssstg.mkcl.org/GatewayServer/',
        ws: true,
        changeOrigin: true,
        pathRewrite: {
          '^/GatewayServer': ''
      ...
      '/templateFilesTeacher': {
        target: 'http://superschoolstg.mkcl.org/spplugins/Teacher/',
        ws: true,
        changeOrigin: true,
        pathRewrite: {
          '^/templateFilesTeacher': ''
      ...
      '/onlineClassroomServer': {
        // Change the below target to your Online Classroom Server URL
        target: 'https://mepcs.mkcl.org/1LUEW7fJDMkpbkkdeyP9xlAjKmu/',
        ws: true,
        changeOrigin: true,
        pathRewrite: {
