  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="col">
          <div class="sub-text">
            {{ questionExtendedData.questionStaticData.questionDetails['optTextStf_' + option.optId] }}
          </div>
        </div>
        <div
          class="col-auto"
      ...
      >
        ...
        <div class="options-img-wrapper">
          <img
            :src="preparePath(questionExtendedData.questionStaticData.questionDetails['optMediaImagePathStf_' + option.optId])"
            alt="Sample image"
            class="options-img"
            @click="setLightboxData(preparePath(questionExtendedData.questionStaticData.questionDetails['optMediaImagePathStf_' + option.optId]), questionExtendedData.questionStaticData.questionDetails['optMediaImageTextStf_' + option.optId])"
          >
          <p class="sub-text">
            {{ questionExtendedData.questionStaticData.questionDetails['optMediaImageTextStf_' + option.optId] }}
          </p>
          <div
            class="check-icon"
            v-if="getCorrectAnswerIndex(option, questionExtendedData.questionLogicalData.questionDetails.optionBucketDetails)"
