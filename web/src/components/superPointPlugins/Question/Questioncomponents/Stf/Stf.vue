<template>
  ...
  >
    ...
    <p
      ...
      class="question-data"
    >
      {{ questionExtendedData.questionStaticData.questionDetails.questionTextStf }}
    </p>
    ...
    >
      <img
        :src="preparePath(questionExtendedData.questionStaticData.questionDetails.questionInMediaImagePathStf)"
        alt="Sample image"
        class="img-fluid question-img"
        @click="togglelightBox"
      >
      <div
        v-if="questionExtendedData.questionStaticData.questionDetails.questionInMediaImageTextStf"
        class="row align-items-center"
      >
        <div class="col-12">
          <p class="question-data">
            {{ questionExtendedData.questionStaticData.questionDetails.questionInMediaImageTextStf }}
          </p>
        </div>
      </div>
      <div
