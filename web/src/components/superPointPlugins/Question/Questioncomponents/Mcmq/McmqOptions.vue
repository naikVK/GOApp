  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="col">
          <div class="sub-text">
            {{ questionExtendedData.questionStaticData.questionDetails['optTextMcmq_' + option.optId] }}
          </div>
        </div>
        <div
          class="col-auto"
      ...
      >
        ...
        <div class="options-img-wrapper">
          <img
            :src="preparePath(questionExtendedData.questionStaticData.questionDetails['optMediaImagePathMcmq_' + option.optId])"
            alt="Sample image"
            class="options-img"
            @click="setLightboxData(preparePath(questionExtendedData.questionStaticData.questionDetails['optMediaImagePathMcmq_' + option.optId]), questionExtendedData.questionStaticData.questionDetails['optMediaImageTextMcmq_' + option.optId])"
          >
          <p class="sub-text">
            {{ questionExtendedData.questionStaticData.questionDetails['optMediaImageTextMcmq_' + option.optId] }}
          </p>
          <div
            class="check-icon"
            v-if="getCorrectAnswerIndex(option, questionExtendedData.questionLogicalData.questionDetails.optionBucketDetails)"
  ...
  computed: {
    getCorrectAnswerIndex () {
      return (option, backetList) => {
        ...
        return temp.optionBucketList.find(backetOption => backetOption.optionIdOpt === option.optId)
      }
    }
  },
  methods: {
