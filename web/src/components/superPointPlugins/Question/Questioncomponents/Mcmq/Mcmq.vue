<template>
  ...
  >
    <p
      ...
      class="question-data"
    >
      {{ questionExtendedData.questionStaticData.questionDetails.questionTextMcmq }}
    </p>
    <div
    ...
    >
      <img
        :src="preparePath(questionExtendedData.questionStaticData.questionDetails.questionInMediaImagePathMcmq)"
        alt="Sample Img"
        class="img-fluid question-img"
        @click="togglelightBox"
      >
      <p class="question-data">
        {{ questionExtendedData.questionStaticData.questionDetails.questionInMediaImageTextMcmq }}
      </p>
      <div
