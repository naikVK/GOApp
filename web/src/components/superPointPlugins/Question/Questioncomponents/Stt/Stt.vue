<template>
  ...
  >
    ...
    <p
      ...
      class="question-data"
    >
      {{ questionExtendedData.questionStaticData.questionDetails.questionTextStt }}
    </p>
    ...
    >
      <img
        :src="preparePath(questionExtendedData.questionStaticData.questionDetails.questionInMediaImagePathStt)"
        alt="Sample image"
        class="img-fluid question-img"
        @click="togglelightBox"
      >
      <div
        v-if="questionExtendedData.questionStaticData.questionDetails.questionInMediaImageTextStt"
        class="row align-items-center"
      >
        <div class="col-12">
          <p class="question-data">
            {{ questionExtendedData.questionStaticData.questionDetails.questionInMediaImageTextStt }}
          </p>
        </div>
      </div>
      <div
